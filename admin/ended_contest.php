            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <table class="table table-bordered" id="result" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                    include("db.php");
                                    $sql="SELECT * FROM exam_status WHERE status='ended' ORDER BY id DESC";
                                    $res=$con->query($sql);
