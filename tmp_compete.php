          ...
          <div class="card">
            <div class="row">
                ...
                <div class="col-md-3 p-3">
                  ...
                  $sql2="SELECT * FROM exam WHERE status='Live'";
                  $res=$con->query($sql2);
                  if($res->num_rows>0){
            ...
            <div class="row mt-4">
                ...
                <table class="p-3" id="table">
                    ...
                    <tbody>
                                    ...
                                    $status=$row4['status'];
                                    echo $status."<br>";
                                    $sql2="SELECT * FROM exam WHERE status='$status' AND id='$exam_status_id'";
                                    $res2=$con->query($sql2);
            ...
            <div class="row mt-4">
                ...
                <table class="" id="table">
                    ...
                    <tbody>
                                   <?php
                                    include("db.php");
                                    $sql2="SELECT * FROM exam WHERE status='ended' ORDER BY id DESC";
                                    $res=$con->query($sql2);
                                    while($row=$res->fetch_assoc())
                                    {
                                    ?>
                      <tr>
                        ...
                        <td><?php echo $row['duration']; ?> Mins</td>
                           <?php
                            ...
                            $sql3="SELECT * FROM exam_question_status WHERE student_id='$student_id'";  
                            $res3=$con->query($sql3);
                            if($res3->num_rows>0)
                            {
                            ?>
                           ...
                           { 
                           ?>
                           <td><a href="" onclick="return alert('Login to continue')">View</a></td>
                           <?php } ?>
                      </tr>
                      <?php } ?>
                    </tbody>
            ...
            const countdownFunction = setInterval(function () {
                ...
                if (timeUntilStart > 0) {
                  ...
                  const days = Math.floor(timeUntilEnd / (1000 * 60 * 60 * 24));
                    ...
                    $(countdownId).html(days + "d " + hours + "h " + minutes + "m " + seconds + "s <span style='color:green;'>Contest Live</span>");
