...
<html lang="en">
  <head>
    ...
    <title>Codeverse Teacher Login</title>
    <!-- plugins:css -->
          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                Teacher<!--<img src="assets/images/logo.svg" alt="logo">-->
                </div>
                                      <?php
                ...
                <form class="pt-3" action="login_tcheck.php" method="post">
                  ...
                  <!-- <div class="text-center mt-4 fw-light"> Don't have an account? <a href="index.php" class="text-primary">Create</a>
                  </div> -->
                </form>
              </div>
            </div>
